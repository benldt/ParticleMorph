...
class SimplexNoise{
  ...
  double noise3D(double x,double y,double z){
    ...
    final t=(i+j+k)*g3;
    final x0i=i-t, y0i=j-t, z0i=k-t;
    var x0=x-x0i, y0=y-y0i, z0=z-z0i;
  ...
  double noise4D(double x,double y,double z,double w){
    final f4=(math.sqrt(5)-1)/4; final g4=(5-math.sqrt(5))/20;
    final s=(x+y+z+w)*f4;
    final i=(x+s).floor(), j=(y+s).floor(), k=(z+s).floor(), l=(w+s).floor();
    final t=(i+j+k+l)*g4;
    final x0i=i-t, y0i=j-t, z0i=k-t, w0i=l-t;
    var x0=x-x0i, y0=y-y0i, z0=z-z0i, w0=w-w0i;
